...
for f in cluster_results.csv graph_features.csv var_order_stats.csv var_order_family_summary.csv oracle_replay_results.csv proof_survey.html classify_supplementals.html classify_supplementals.txt; do
    echo "pulling $f ..."
